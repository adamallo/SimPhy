...
long int WriteSTreeDB(sqlite3 **database, int n_leaves, double sb_rate, double sd_rate, int bds_leaves, double bds_length, double height, double length, double outgroup, int ind_per_sp, int n_loci, double b_rate,double d_rate, double t_rate, double gc_rate, double alpha_s, double alpha_l, double salpha_g, int Ne, double mu, double gen_time)
{
	...
	sprintf(query,"INSERT INTO Species_Trees VALUES(NULL,'%d','%e','%e','%d','%e','%e','%e','%e','%d','%d','%e','%e','%e','%e','%e','%e','%e','%d','%e','%e',0,0,0)",n_leaves,sb_rate,sd_rate,bds_leaves,bds_length,height,length,outgroup,ind_per_sp,n_loci,b_rate,d_rate,t_rate,gc_rate,alpha_s,alpha_l,salpha_g,Ne,mu,gen_time); //67+numbers
...
long int WriteLTreeDB(sqlite3 **database, int n_ltree, int SID, double b_rate, double d_rate, double t_rate, double gc_rate,int n_leaves, int n_dup, int n_loss, int n_transf, int n_gc, double gamma, double lalpha_g)
{
	char *query;
	char *zErrMsg=NULL;
	int db_iserror=0;
	...
	sprintf(query,"INSERT INTO Locus_Trees VALUES(NULL,'%d','%d','%e','%e','%e','%e','%d','%d','%d','%d','%d','%e','%e')",n_ltree,SID,b_rate,d_rate,t_rate,gc_rate,n_leaves,n_dup,n_loss,n_transf,n_gc,gamma,lalpha_g); //63+numbers
	db_iserror=sqlite3_exec(*database,query,NULL,NULL,&zErrMsg);
