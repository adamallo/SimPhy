...
//#endif
    ...
    else
    {
        ...
        for (j=0;j<avail_leaves;++j)
        {
            w_node1=*(node_ptrs+j);
            w_node1->n_gen=time;
            w_node1->gen_length=time-w_node1->anc_node->n_gen;
            w_node1->n_replicas=ind_per_sp;
                ...
                if (w_lnode2!=NULL)
                {
                    switch (discarded_t)
                    {
                        ...
                        default:
                            ...
                            (*(w_lnode2->childs))->gen_length=(*(w_lnode2->childs))->n_gen-w_lnode2->anc_node->n_gen;
